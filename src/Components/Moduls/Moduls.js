...
function Moduls() {
  ...
  return (
    ...
    <ul className={styles.li}>
    <h6>Модуль №3</h6>
        <li><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="#d52027" d="M256 0a256 256 0 1 0 0 512A256 256 0 1 0 256 0zM135 241c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l87 87 87-87c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9L273 345c-9.4 9.4-24.6 9.4-33.9 0L135 241z"/></svg>Договора на аренду квартиры (виды/ отличия)</li>
