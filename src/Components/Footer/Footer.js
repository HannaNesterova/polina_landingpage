        ...
        <div className={styles.container} id='contacts-section'  onDoubleClick={handleAreaDoubleClick}>
            ...
            data-aos="fade-down" data-aos-duration="3000">
                <div className={styles.socialmedia}>
                    <a href='https://www.instagram.com/polins_pl/' target='_blank'>
                    ...
                    <a href='https://www.youtube.com/@PolinsPL' target='_blank'>
                    ...
                    <a href='https://t.me/polins_pl' target='_blank'>
                    ...
                    <a href='https://www.tiktok.com/@polins_pl' target='_blank'>
